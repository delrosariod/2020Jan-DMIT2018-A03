...
<div>
    ...
    <div class="col-sm-2">
        ...
        <asp:DropDownList ID="MediaTypeDDL" runat="server"
            ...
            DataValueField="IDValueField" AppendDataBoundItems="true" AutoPostBack="True" OnSelectedIndexChanged="MediaTypeDDL_SelectedIndexChanged">
    ...
    <div class="col-sm-10">
        ...
        <asp:Panel ID ="TrackSelectionListArgs" runat="server" Visible="false">
        ...
        <asp:LinkButton ID="DeleteTrack" runat="server"
            ...
            OnClientClick="return confirm('Are you sure you want to delete the song(s) from the playlist?')">
    ...
    <asp:ObjectDataSource ID="TrackSelectionListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Track_GetTracksByTrackandID" TypeName="ChinookSystem.BLL.TrackController" OnSelected="CheckForException">
        <SelectParameters>
            <asp:ControlParameter ControlID="TracksBy" PropertyName="Text" DefaultValue="asdasdasd32b93v4728vwdvaasdadvasdasdvw3rv3evw" Name="tracksby" Type="String"></asp:ControlParameter>
            <asp:ControlParameter ControlID="SearchArg" PropertyName="Text" DefaultValue="asdn7c7c937c983r98kcus09c09sida`" Name="searchArg" Type="String"></asp:ControlParameter>
        </SelectParameters>
    </asp:ObjectDataSource>
